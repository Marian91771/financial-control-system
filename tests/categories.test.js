...
describe('Categories API', () => {
    ...
    describe('POST /categories/new', () => {
        it('should add a category and return insertId', async () => {
            ...
            const res = await request(app).post('/categories/new').query({ name: 'NewCat' });
        ...
        it('should handle errors', async () => {
            ...
            const res = await request(app).post('/categories/new').query({ name: 'X' });
    ...
    describe('PUT /categories/edit/:id', () => {
        it('should update a category and return success message', async () => {
            ...
            const res = await request(app).put('/categories/edit/5').query({ name: 'Updated' });
        ...
        it('should handle errors', async () => {
            ...
            const res = await request(app).put('/categories/edit/5').query({ name: 'X' });
